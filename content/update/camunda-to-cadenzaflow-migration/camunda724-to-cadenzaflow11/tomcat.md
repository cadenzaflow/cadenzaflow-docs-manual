...
title: "Update a Tomcat Installation from Camunda 7.24 to CadenzaFlow 1.1"

menu:
  main:
    name: "Tomcat"
    identifier: "migration-guide-camunda-724-cadenzaflow-11-tomcat"
    parent: "migration-guide-camunda-724-cadenzaflow-11"
...
[CadenzaFlow 1.0.x Tomcat distribution][tomcat-distribution].
...
* `groovy-jsr224-$GROOVY_VERSION.jar`
...
[update-guide]: {{< ref "/update/camunda-to-cadenzaflow-migration/camunda724-to-cadenzaflow11/_index.md" >}}
