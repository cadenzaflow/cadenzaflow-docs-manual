...
1. Download the CadenzaFlow web application that contains both applications from our [Artifact Repository](https://nexus.cadenzaflow.com/service/rest/repository/browse/cadenzaflow-nexus/org/cadenzaflow/bpm/webapp/cadenzaflow-webapp-tomcat/).
   Or switch to the private repository for the enterprise version (User and password from license required).
    * For [Tomcat 10](https://nexus.cadenzaflow.com/service/rest/repository/browse/cadenzaflow-nexus/org/cadenzaflow/bpm/webapp/cadenzaflow-webapp-tomcat-jakarta/#browse/browse), the name of the artifact is `$PLATFORM_VERSION/camunda-webapp-tomcat-jakarta-$PLATFORM_VERSION.war`.
...
1. Download the REST API web application archive from our [Artifact Repository](https://downloads.cadenzaflow.com/artifacts/cadenzaflow-bpm/org/cadenzaflow/bpm/cadenzaflow-engine-rest/).
    Or switch to the private repository for the enterprise version (User and password from license required).
    * For [Tomcat 10](https://nexus.cadenzaflow.com/service/rest/repository/browse/cadenzaflow-nexus/org/cadenzaflow/bpm/cadenzaflow-engine-rest-jakarta/), the name of the artifact is `$PLATFORM_VERSION/camunda-engine-rest-jakarta-$PLATFORM_VERSION-tomcat.war`.
