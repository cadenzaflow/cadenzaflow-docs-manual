...
If you installed the default CadenzaFlow webapps and demo content, CadenzaFlow was configured with several demo users. The default admin user can be accessed with the following credentials:
