...
Tasklist can be localized. CadenzaFlow maintains English and German translation files. 
...
```
This includes a `custom-module/module.js` file. The path is relative to the `app/tasklist` folder in the CadenzaFlow webapp .war file.

You can find a complete example about how to use `customScripts` to develop a Tasklist Plugin in the [CadenzaFlow examples repository](https://github.com/cadenzaflow/cadenzaflow-bpm-examples/tree/master/tasklist/cats-plugin).
...
```css
.navbar-brand {
  /* hides the "CadenzaFlow Tasklist" text */
  text-indent: -999em;
  /* put your logo */
...
**Note:** you can also change the app name (*Tasklist*) and vendor (*CadenzaFlow*)
