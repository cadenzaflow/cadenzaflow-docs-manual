...
menu:
  main:
    ...
    pre: "A CSRF-Prevention Filter for the CadenzaFlow Web Applications"
---
...
```xml
  ...
  <filter>
    ...
    <filter-class>org.cadenzaflow.bpm.webapp.impl.security.filter.CsrfPreventionFilter</filter-class>
    <init-param>
