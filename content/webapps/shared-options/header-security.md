...
menu:
  main:
    ...
    pre: "A HTTP Header Security Filter for the CadenzaFlow Web Applications"
---
...
It is a common practice to extend CadenzaFlow web applications by custom scripts and forms.
