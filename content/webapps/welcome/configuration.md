...
export default {
  ...
  links: [
    {
      label: 'CadenzaFlow Forum',
      href: 'https://forum.cadenzaflow.org',
...
```css
.navbar-brand {
  /* hides the "CadenzaFlow Welcome" text */
  text-indent: -999em;
  /* put your logo */
...
**Note:** you can also change the app name (*Welcome*) and vendor (*CadenzaFlow*)
...
Welcome can be localized. CadenzaFlow maintains English and German translation files. 
You can find and download community maintained translation files at the [CadenzaFlow webapp translations repository](https://github.com/cadenzaflow-community-hub/cadenzaflow-7-webapp-translations).
