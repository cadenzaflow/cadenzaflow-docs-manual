...
The basic skeleton of a Cockpit plugin looks as follows:
    ...
    |   |   └── resources/
    |   |       ├── META-INF/services/
    |   |       |   └── org.cadenzaflow.bpm.cockpit.plugin.spi.CockpitPlugin  (2)
...
{{< note title="Related Example" class="info">}}
  [How to develop a Cockpit plugin](https://github.com/cadenzaflow/cadenzaflow-bpm-examples/tree/master/cockpit/cockpit-fullstack-count-processes)
{{< /note >}}
...
For more details about legacy Plugins, check out the legacy [Camund aPlugin documentation](https://docs.camunda.org/manual/7.13/webapps/cockpit/extend/plugins/). Please note that this link will take you to the documentation of Camunda **7.13** .
...
For more information on creating and configuring your own plugin, please see [How to develop a Cockpit plugin](https://github.com/cadenzaflow/cadenzaflow-bpm-examples/tree/master/cockpit/cockpit-fullstack-count-processes).
...
**REST Endpoint:** `POST /cadenzaflow/api/admin/auth/user/default/login/cockpit`
