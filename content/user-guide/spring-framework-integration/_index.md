...
The cadenzaflow-engine Spring Framework integration is located inside a maven module and can be added to apache maven-based projects through the following dependency:

{{< note title="" class="info" >}}
  Please import the [CadenzaFlow BOM](/get-started/apache-maven/) to ensure correct versions for every CadenzaFlow project.
{{< /note >}}

* `cadenzaflow-engine-spring` maven module for Spring Framework 5
...
* `cadenzaflow-engine-spring-6` maven module for Spring Framework 6.
