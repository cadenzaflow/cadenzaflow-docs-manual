...
They enable a quickstart for developing production-ready process applications using CadenzaFlow.
...
The following archetypes are currently provided. They are distributed via our Maven repository: https://nexus.cadenzaflow.com/service/rest/repository/browse/cadenzaflow-nexus/org/cadenzaflow/bpm/
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      <td><a href="https://nexus.cadenzaflow.com/service/rest/repository/browse/cadenzaflow-nexus/org/cadenzaflow/bpm/archetype/cadenzaflow-archetype-cockpit-plugin/">CadenzaFlow Cockpit Plugin</a></td>
      <td>Plugin for CadenzaFlow Cockpit, contains REST-Backend, MyBatis database query, HTML and JavaScript frontend, Ant build script for one-click deployment</td>
    </tr>
    <tr>
      <td><a href="https://nexus.cadenzaflow.com/service/rest/repository/browse/cadenzaflow-nexus/org/cadenzaflow/bpm/archetype/cadenzaflow-archetype-servlet-war/">Process Application (Servlet, WAR)</a></td>
      <td>Process application that uses a shared CadenzaFlow engine in a Servlet Container, e.g., Apache Tomcat.
    ...
    <tr>
      <td><a href="https://nexus.cadenzaflow.com/service/rest/repository/browse/cadenzaflow-nexus/org/cadenzaflow/bpm/archetype/cadenzaflow-archetype-spring-boot/">CadenzaFlow Spring Boot Application</a></td>
      <td>Application that uses the CadenzaFlow Spring Boot Starter.
          Contains: Spring Boot Process Application, CadenzaFlow Webapps, BPMN Process, Java Delegate, HTML5-based start and task forms,
          JUnit Test with in-memory engine, Maven Plugins for packing as an executable application.</td>
    </tr>
    <tr>
      <td><a href="https://nexus.cadenzaflow.com/service/rest/repository/browse/cadenzaflow-nexus/org/cadenzaflow/bpm/archetype/cadenzaflow-archetype-spring-boot-demo/">CadenzaFlow Spring Boot Application with Demo Users</a></td>
      <td>Same as the <i>Spring Boot Application</i> archetype and additionally creates demo users and groups for easy start with the CadenzaFlow Webapps (use <code>demo/demo</code> to log in).</td>
    </tr>
    <tr>
      <td><a href="https://nexus.cadenzaflow.com/service/rest/repository/browse/cadenzaflow-nexus/org/cadenzaflow/bpm/archetype/cadenzaflow-archetype-engine-plugin/">Process Engine Plugin</a></td>
...
We provide a template repository for every CadenzaFlow Archetype. 
Every repository contains a project generated from one specific template.
You can find the whole list on [GitHub](https://github.com/cadenzaflow?q=%22cadenzaflow-bpm-archetype-%22).

With every new release of the Archetypes, we will update those repositories with a new version as well.
This allows to investigate possible update paths from one CadenzaFlow version to another and also enables you to simply update your existing project by pulling in the latest changes.
...
2. Enter the following URL and description, click on **Verify...** to test the connection and if that worked click on **OK** to save the catalog.
    ...
    Catalog File: **https://nexus.cadenzaflow.com/service/rest/repository/browse/cadenzaflow-nexus/org/cadenzaflow/bpm/**

    Description: **CadenzaFlow**
...
4. Specify Maven coordinates and CadenzaFlow version and finish the project creation.
{{< img src="../img/eclipse-05-specify-maven-coordinates-and-cadenzaflow-version.png" title="Eclipse: Specify Maven coordinates and CadenzaFlow version" >}}
...
Sometimes the creation of the very first Maven project fails in Eclipse. If that happens to you, just try it again. Most of the times the second try works. If the problem persists, [contact us](https://forum.cadenzaflow.org/).
...
7. In the Maven Archetype Catalogs window, click on the "+" button, and in the opened "Add Archetype Catalog URL"
   modal window add the  URL of the catalog file: https://nexus.cadenzaflow.com/service/rest/repository/browse/cadenzaflow-nexus/archetype-catalog.xml.
...
9. In the new project dialog, click on the left side on "Maven", check "Create from archetype" 
   and select any `org.cadenzaflow.bpm.archetype` entry.
...
<pre class="console">
mvn archetype:generate -Dfilter=org.cadenzaflow.bpm.archetype:
</pre>
...
mvn archetype:generate \
  ...
  -DarchetypeGroupId=org.cadenzaflow.bpm.archetype \
  -DarchetypeArtifactId=cadenzaflow-archetype-ejb-war \
  -DarchetypeVersion=1.0.0 \
  -DgroupId=org.example.cadenzaflow.bpm \
  -DartifactId=cadenzaflow-bpm-ejb-project \
  -Dversion=0.0.1-SNAPSHOT \
  -Dpackage=org.example.cadenzaflow.bpm.ejb
</pre>


# Source Code and Customization

You can also customize the project templates for your own technology stack. Just [fork them on GitHub](https://github.com/cadenzaflow/cadenzaflow-archetypes)!
