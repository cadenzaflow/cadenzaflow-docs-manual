...
Process variables are available for injection. CadenzaFlow CDI supports
...
To implement resolution from contextual data, the producer bean `org.cadenzaflow.bpm.engine.cdi.impl.ProcessEngineServicesProducer`
