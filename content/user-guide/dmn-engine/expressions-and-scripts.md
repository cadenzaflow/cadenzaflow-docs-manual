...
The CadenzaFlow DMN engine supports two expression languages out of the box:

- `JUEL`: A CadenzaFlow-maintained [implementation][juel] of the Java [Unified Expression Language][EL]
...
<definitions xmlns="https://www.omg.org/spec/DMN/20191111/MODEL/" id="definitions" name="definitions" namespace="http://cadenzaflow.org/schema/1.0/dmn" expressionLanguage="javascript">
  <decision  id="decision" name="Decision">
    <decisionTable>
      <!-- ... -->
    </decisionTable>
