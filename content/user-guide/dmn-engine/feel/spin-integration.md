...
This page documents how CadenzaFlow Spin can be used together with the Scala FEEL Engine. Furthermore, 
...
capable of using Spin, if another component of CadenzaFlow (here, the FEEL Engine) 
supports its usage. 
...
[type doc]: https://cadenzaflow.github.io/feel-scala/1.11/feel-data-types
[spin plugin]: {{< ref "/user-guide/data-formats/configuring-spin-integration.md#cadenzaflow-engine-plugin-spin" >}}
