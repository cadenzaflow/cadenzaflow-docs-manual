...
[FEEL Scala Engine][] (opens external link) in the CadenzaFlow DMN Engine. To see how FEEL can be used in other BPMN elements, visit: [Friendly Enough Expression Language guide]({{< ref "/user-guide/process-engine/expression-language/friendly-enough-expression-language.md" >}})

{{< note title="Heads Up!" class="info" >}}
If you come from a Camunda version <= 7.12.x and already use FEEL, 
...
[FEEL Scala Engine]: https://github.com/cadenzaflow/feel-scala
