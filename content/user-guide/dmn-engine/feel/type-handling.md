...
* ...well integrable in CadenzaFlow
...
* `org.cadenzaflow.spin.json.SpinJsonNode`
* `org.cadenzaflow.spin.xml.SpinXmlElement`

For more information about the CadenzaFlow Spin integration, please see the documentation about 
...
* Which CadenzaFlow specific variable type is assigned for the respective Java type

<table class="table table-striped">
  <tr>
    <th>FEEL Expression Example</th>
    <th>FEEL Engine Return Type</th>
    <th>CadenzaFlow Variable Type</th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><code>org.cadenzaflow.feel.syntaxtree.ZonedTime</code></td>
    <td>object</td>
  </tr>
  <tr>
