...
The CadenzaFlow DMN engine is a Java library which can evaluate DMN decision tables.
...
application or in combination with CadenzaFlow. This section
covers how to embed the library and use it to evaluate decisions. For more
information on the integration in CadenzaFlow, please see the
...
[GitHub]: https://github.com/cadenzaflow/cadenzaflow-bpm-examples/tree/master/dmn-engine/dmn-engine-java-main-method
