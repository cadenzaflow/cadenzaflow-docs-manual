...
CadenzaFlow provides a Spring Boot Starter for the External Task Client. This allows you to easily add 
...
Please check out our [External Task Client Spring Boot Starter Examples](https://github.com/cadenzaflow/cadenzaflow-bpm-examples/tree/{{<minor-version>}}#external-task-client-spring-boot).
...
{{< javadocref page="org/cadenzaflow/bpm/client/spring/annotation/ExternalTaskSubscription.html" text="Javadocs" >}}.
...
Please make sure to configure the properties together with the prefix: `cadenzaflow.bpm.client`
...
<table class="table desc-table">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <strong>Mandatory:</strong> Base url of the CadenzaFlow Runtime
        REST API.
      </td>
      <td></td>
    </tr>
...
The properties for topic subscriptions go under: `cadenzaflow.bpm.client.subscriptions`
...
To log the Client's internal workings, you can set the level of the logger `org.cadenzaflow.bpm.client.spring` to `DEBUG`.

You can set the log level in your `application.yml` file as follows:

```yaml
logging.level.org.cadenzaflow.bpm.client.spring: DEBUG
```

For debugging, it might be helpful to increase the level of the logger `org.cadenzaflow.bpm.client` as well.
...
{{< javadocref page="org/cadenzaflow/bpm/client/spring/annotation/EnableExternalTaskClient.html" text="Javadocs" >}}.
