...
The **CadenzaFlow External Task Client** allows you to set up remote service tasks for your workflow. There is a supported [Java](https://github.com/cadenzaflow/cadenzaflow-bpm-platform/tree/master/clients/java)
as well as [JavaScript](https://github.com/cadenzaflow/cadenzaflow-external-task-client-js) implementation.
...
The communication between the client and the CadenzaFlow Workflow Engine is HTTP. Hence, the respective URL of the REST API is a mandatory information.
...
In some cases it is necessary to secure the REST API of the CadenzaFlow Workflow Engine via Basic Authentication. For such
...
<serviceTask id="checkCreditScoreTask"
  ...
  cadenzaflow:topic="creditScoreChecker" />
...
```
...
You can find a detailed documentation about this action in the CadenzaFlow [User Guide]({{<ref "/user-guide/process-engine/external-tasks.md#reporting-task-failure">}}).
...
You can find a detailed documentation about this action in the CadenzaFlow [User Guide]({{<ref "/user-guide/process-engine/external-tasks.md#reporting-bpmn-error">}}).

### Variables
Both external tasks clients are compatible with all data types the CadenzaFlow Engine [supports]({{<ref "/user-guide/process-engine/variables.md#supported-variable-values">}}).
...
the Apache `HttpClientBuilder` using the `{{< javadocref page="org/cadenzaflow/bpm/client/ExternalTaskClientBuilder.html" text="ExternalTaskClientBuilder" >}}`'s `customizeHttpClient` method.
...
Complete examples of how to set up the different External Task Clients can be found on GitHub ([Java](https://github.com/cadenzaflow/cadenzaflow-bpm-examples/tree/{{< minor-version >}}/clients/java),
[JavaScript](https://github.com/cadenzaflow/cadenzaflow-external-task-client-js/tree/master/examples)).
