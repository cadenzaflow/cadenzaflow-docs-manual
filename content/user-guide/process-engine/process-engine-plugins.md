...
{{< javadocref page="org/cadenzaflow/bpm/engine/impl/cfg/ProcessEnginePlugin.html" text="ProcessEnginePlugin" >}} interface.
...
* in the [CadenzaFlow Deployment Descriptors]({{< ref "/reference/deployment-descriptors/_index.md" >}}) (bpm-platform.xml/processes.xml),
* using [Spring Beans XML]({{< ref "/user-guide/spring-framework-integration/_index.md#configure-a-process-engine-plugin-in-spring" >}}),
* in the [CadenzaFlow Run YAML configuration files]({{< ref "/user-guide/cadenzaflow-bpm-run.md#process-engine-plugin-registration" >}})
* programatically.
...
<bpm-platform xmlns="http://www.cadenzaflow.org/schema/1.0/BpmPlatform"
  ...
  <process-engine name="default">
    ...
    <plugins>
      <plugin>
        <class>org.cadenzaflow.bpm.engine.MyCustomProcessEnginePlugin</class>
        <properties>
