...
CadenzaFlow provides an integration of the [CadenzaFlow DMN engine] to
...
repository of CadenzaFlow. Deployed decisions can be evaluated
...
[CadenzaFlow DMN engine]: {{< ref "/user-guide/dmn-engine/_index.md" >}}
