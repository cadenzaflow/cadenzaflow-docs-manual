...
of the type `{{< javadocref page="org/cadenzaflow/bpm/engine/ProcessEngineException.html" text="ProcessEngineException" >}}`.
...
Sometimes you may want to assign codes to specific errors CadenzaFlow hasn't covered so far.
...
With the help of a [`ProcessEnginePlugin`]({{< ref "/user-guide/process-engine/process-engine-plugins.md" >}}) you can register a custom `{{< javadocref page="org/cadenzaflow/bpm/engine/impl/errorcode/ExceptionCodeProvider.html" text="ExceptionCodeProvider" >}}`:
