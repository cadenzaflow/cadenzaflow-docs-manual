...
In the [CadenzaFlow Full Distributions][2], the
...
<bean id="processEngineConfiguration" class="org.cadenzaflow.bpm.engine.impl.cfg.StandaloneInMemProcessEngineConfiguration">
  ...
  <property name="idGenerator">
    <bean class="org.cadenzaflow.bpm.engine.impl.persistence.StrongUuidGenerator" />
  </property>
...
[2]: {{< ref "/introduction/downloading-cadenzaflow.md#full-distribution" >}}
