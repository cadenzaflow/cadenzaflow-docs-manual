...
The following properties are available in the `org.cadenzaflow.bpm.engine.ProcessEngineConfiguration` class:
...
```java
org.cadenzaflow.bpm.engine.impl.cfg.ProcessEngineConfigurationImpl.setCustomIncidentHandlers(List<IncidentHandler>)
```
...
{{< javadocref page="org/cadenzaflow/bpm/engine/impl/incident/CompositeIncidentHandler.html" text="Composite Incident Handler" >}}.