...
2.  In Spring-based environments via [Spring XML Configuration][spring-xml-config] 
    ...
    <bean id="processEngineConfiguration" 
          class="org.cadenzaflow.bpm.engine.impl.cfg.StandaloneInMemProcessEngineConfiguration">
...
3.  In Spring Boot environment via the [`application.yaml`][spring-boot-config] file
    ```yaml
    cadenzaflow.bpm.generic-properties.properties:
...
[spring-boot-config]: {{< ref "/user-guide/spring-boot-integration/configuration.md#cadenzaflow-engine-properties" >}}