...
{{< enterprise >}}
  The CadenzaFlow enterprise edition provides a user interface to compose process instance modifications visually on the BPMN diagram in [CadenzaFlow Cockpit]({{< ref "/webapps/cockpit/bpmn/process-instance-modification.md" >}})
{{< /enterprise >}}
