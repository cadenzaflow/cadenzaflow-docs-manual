...
Diagnostics data is constantly collected and can be collected only by you. This allows you to access the collected data through the Java and REST APIs of CadenzaFlow.
Being able to easily access the collected data is helpful when asking for help in our [forum](https://forum.cadenzaflow.org/) or when opening issues in our [issue tracker](https://app.cadenzaflow.com/jira) as it contains many of the information that are usually necessary to understand your CadenzaFlow setup.
...
* Product name - the name of the product (i.e., `CadenzaFlow BPM Runtime`)
...
* it is set to the engine via [Admin Webapp](https://docs.cadenzaflow.org/manual/latest/webapps/admin/system-management/#cadenzaflow-license-key)
...
* Used CadenzaFlow Web Applications
...
* CadenzaFlow integration - a flag that shows if any of the CadenzaFlow integrations are used: Spring boot starter, CadenzaFlow Platform Run, CadenzaFlow EJB service.
    ...
    "product": {
      ...
      "internals": {
        ...
        "license-key": {
          ...
          "raw": "customer=customer name;expiryDate=2022-09-30;cadenzaflowBPM=true;optimize=false;cawemo=false"
        },
        "webapps": [
          "cockpit",
          "admin"
...
In case you want further details, you can have a look at the implementation of the diagnostics topic in [our codebase](https://github.com/cadenzaflow/cadenzaflow-bpm-platform/blob/master/engine/src/main/java/org/cadenzaflow/bpm/engine/impl/diagnostics/DiagnosticsCollector.java). The link leads you to the current `master` version of the feature.
