...
The previous JavaScript BPMN renderer can still be found at [cadenzaflow-bpmn.js](https://github.com/cadenzaflow/cadenzaflow-bpmn.js), but it is not actively developed anymore.
...
Alternatively, you can use the  [bpmn-viewer widget](https://github.com/cadenzaflow/cadenzaflow-bpm-platform/blob/master/webapps/frontend/cadenzaflow-commons-ui/lib/widgets/bpmn-viewer/cam-widget-bpmn-viewer.html) from the CadenzaFlow commons UI.
