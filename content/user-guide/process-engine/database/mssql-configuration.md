...
Microsoft SQL Server or Microsoft Azure SQL databases with CadenzaFlow. It provides guides
on:
...
* How CadenzaFlow supports Azure SQL.
* How to configure a database on Azure SQL to be supported by CadenzaFlow.
...
# CadenzaFlow support for Azure SQL
...
## Azure SQL compatibility levels supported by CadenzaFlow
...
CadenzaFlow supports the *Database Compatibility Level* values of the currently supported Microsoft 
...
behavior unsupported by CadenzaFlow.
