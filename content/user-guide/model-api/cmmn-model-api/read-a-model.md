...
String custom2 = humanTask.getAttributeValueNs("custom-attribute-2", "http://cadenzaflow.org/custom");

// edit attributes by generic XML model API (with optional namespace)
humanTask.setAttributeValue("custom-attribute", "new value");
humanTask.setAttributeValueNs("custom-attribute", "http://cadenzaflow.org/custom", "new value");
```
...
<definitions targetNamespace="http://cadenzaflow.org/examples"
