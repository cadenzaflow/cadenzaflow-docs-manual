...
```java
@XmlRootElement(name="customer", namespace="http://cadenzaflow.org/test")
public class Customer {

  private String name;

  @XmlElement(namespace="http://cadenzaflow.org/test")
...
<customer xmlns="http://cadenzaflow.org/example">
  <name>Kermit</name>
</customer>
 ```
...
String xmlInput = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><customer xmlns=\"http://cadenzaflow.org/example\"><name>Kermit</name></customer>";
