...
String xml = "<root xmlns:t=\"http://cadenzaflow.org\"><t:child id=\"child\"><a id=\"a\"/></t:child></root>";

SpinXmlTreeElement child = XML(xml).xPath("/root/t:child")
                                   .ns("t", "http://cadenzaflow.org");
                                   .element();
```
...
namespaceMap.put("t", "http://cadenzaflow.org");
namespaceMap.put("s", "http://cadenzaflow.com");
...
{{< note class="info" >}}
  ...
  E.g.,: ```<root xmlns="http://cadenzaflow.org"></root>``` -- prefix: DEFAULT, namespace: http://cadenzaflow.org so you need
