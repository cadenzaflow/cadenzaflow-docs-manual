...
<dependency>
  ...
  <artifactId>cadenzaflow-engine-rest</artifactId>
...
<dependency>
  <groupId>org.cadenzaflow.bpm</groupId>
  <artifactId>cadenzaflow-engine-rest-jakarta</artifactId>
  <classifier>classes</classifier>
</dependency>
```
...
public class MyApplication extends Application {
  ...
  public Set<Class<?>> getClasses() {
    ...
    ...
    // add all cadenzaflow engine rest resources (or just add those that you actually need).
    classes.addAll(CadenzaFlowRestResources.getResourceClasses());

    // mandatory
    classes.addAll(CadenzaFlowRestResources.getConfigurationClasses());
...
`org.cadenzaflow.bpm.engine.rest.exception.JsonMappingExceptionHandler` and `org.cadenzaflow.bpm.engine.rest.exception.JsonParseExceptionHandler`.
...
If you would like to have all kinds of exceptions translated to this format, you can use `org.cadenzaflow.bpm.engine.rest.exception.ExceptionHandler` instead of `ProcessEngineExceptionHandler`.
...
and declare it in a file `META-INF/services/org.cadenzaflow.bpm.engine.rest.spi.ProcessEngineProvider`.
You may also declare the class `org.cadenzaflow.bpm.engine.rest.impl.application.ContainerManagedProcessEngineProvider`
which comes with the REST API and uses the methods that the class `org.cadenzaflow.bpm.BpmPlatform` provides.
