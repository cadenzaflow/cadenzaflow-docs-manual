...
This caching can be configured in the `web.xml` file of the REST API (or the CadenzaFlow Web Application in
case the REST API is embedded into the CadenzaFlow Web Application).
...
<web-app version="2.5" xmlns="http://java.sun.com/xml/ns/javaee"
  ...
  <listener>
    <listener-class>org.cadenzaflow.bpm.engine.rest.hal.cache.HalRelationCacheBootstrap</listener-class>
  </listener>

  <context-param>
    <param-name>org.cadenzaflow.bpm.engine.rest.hal.cache.config</param-name>
    <param-value>
      {
        "cacheImplementation": "org.cadenzaflow.bpm.engine.rest.hal.cache.DefaultHalResourceCache",
        "caches": {
          "org.cadenzaflow.bpm.engine.rest.hal.user.HalUser": {
            "capacity": 100,
            "secondsToLive": 900
          },
          "org.cadenzaflow.bpm.engine.rest.hal.group.HalGroup": {
            "capacity": 100,
            "secondsToLive": 900
          },
          "org.cadenzaflow.bpm.engine.rest.hal.processDefinition.HalProcessDefinition": {
            "capacity": 100,
            "secondsToLive": 600
          }
        }
...
`org.cadenzaflow.bpm.engine.rest.hal.cache.config`. The configuration is provided
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      ...
      <code>org.cadenzaflow.bpm.engine.rest.cache.Cache</code> interface.
      A simple default implementation is provided by the
      <code>org.cadenzaflow.bpm.engine.rest.hal.cache.DefaultHalResourceCache</code> class.
    </td>
  </tr>
  <tr>
    <td>caches</td>
...
* Case Definition: `org.cadenzaflow.bpm.engine.rest.hal.caseDefinition.HalCaseDefinition`
* Group: `org.cadenzaflow.bpm.engine.rest.hal.group.HalGroup`
* Identity Links (of a Task): `org.cadenzaflow.bpm.engine.rest.hal.identitylink.HalIdentityLink`
* Process Definition: `org.cadenzaflow.bpm.engine.rest.hal.processDefinition.HalProcessDefinition`
* Task: `org.cadenzaflow.bpm.engine.rest.hal.task.HalTask`
* User: `org.cadenzaflow.bpm.engine.rest.hal.user.HalUser`
