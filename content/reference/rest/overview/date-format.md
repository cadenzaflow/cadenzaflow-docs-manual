...
`org.cadenzaflow.bpm.engine.rest.jackson.dateFormat`.
...
<web-app version="2.5" xmlns="http://java.sun.com/xml/ns/javaee"
  ...
  <listener>
    <listener-class>
      org.cadenzaflow.bpm.engine.rest.CustomJacksonDateFormatListener
    </listener-class>
  </listener>

  <context-param>
    <param-name>org.cadenzaflow.bpm.engine.rest.jackson.dateFormat</param-name>
...
Be aware that, to be able to use the CadenzaFlow webapps, the date format must correspond to the following:
