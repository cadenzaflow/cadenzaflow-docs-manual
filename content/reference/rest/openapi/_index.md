...
The CadenzaFlow REST API has an OpenAPI description that follows the
...
Download the CadenzaFlow REST API artifact containing the OpenAPI documentation [here][artifact-link]. Choose the correct version and then download the `jar` file.

[spec-3.0.2]: https://github.com/OAI/OpenAPI-Specification/blob/3.0.2/versions/3.0.2.md
[artifact-link]: https://nexus.cadenzaflow.com/service/rest/repository/browse/cadenzaflow-nexus/org/cadenzaflow/bpm/cadenzaflow-engine-rest-openapi/
...
<dependency>
  ...
  <artifactId>cadenzaflow-engine-rest-openapi</artifactId>
...
[cam-platform-run]: {{< ref "/user-guide/cadenzaflow-bpm-run.md" >}}
