...
was integrated into CadenzaFlow.
{{< /note >}}

The CadenzaFlow DMN engine supports the following FEEL data types.
...
FEEL supports numeric types like integer. In the CadenzaFlow DMN engine the
...
FEEL supports date types. In the CadenzaFlow DMN engine the following date types
are available:
