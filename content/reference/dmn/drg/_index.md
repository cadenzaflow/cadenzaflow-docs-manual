...
```xml
<definitions xmlns="https://www.omg.org/spec/DMN/20191111/MODEL/" id="dinnerDecisions" name="Dinner Decisions" namespace="http://cadenzaflow.org/schema/1.0/dmn">
...
Each DRG should have an unique id when it is [deployed] to CadenzaFlow.
...
Note that an input data has no execution semantics and is ignored by the CadenzaFlow DMN engine.
...
Note that a knowledge source has no execution semantics and is ignored by the CadenzaFlow DMN engine.
