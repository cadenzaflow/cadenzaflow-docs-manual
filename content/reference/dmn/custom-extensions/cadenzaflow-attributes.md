...
menu:
  main:
    ...
    pre: "Reference of CadenzaFlow Extension Attributes for DMN."

aliases: [reference/dmn11/custom-extensions/cadenzaflow-attributes/]
---

The following attributes are extension attributes for the `cadenzaflow` namespace `http://cadenzaflow.org/schema/1.0/dmn`.
