...
The namespace for the processes.xml file is `http://www.cadenzaflow.org/schema/1.0/ProcessApplication`. The XSD file can be found in the `cadenzaflow-engine.jar` file.
