...
menu:
  main:
    ...
    pre: "Reference of CadenzaFlow Extension Attributes for CMMN."

---

The following attributes are extension attributes for the `cadenzaflow` namespace `http://cadenzaflow.org/schema/1.0/cmmn`.
...
<table class="table table-striped">
  ...
  <tr>
    <th>Constraints</th>
    <td colspan="2">
      If the value is set to <code>version</code> the attribute <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-attributes.md#caseversion" >}}">cadenzaflow:caseVersion</a> is required, see <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-attributes.md#casebinding" >}}">Case Binding</a> for more information.
    </td>
  </tr>
  <tr>
    <th>Default Value</th>
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      ...
      cadenzaflow:caseExecutionListener
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Constraints</th>
    <td colspan="2">
      If the value is set to <code>version</code> the attribute <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-attributes.md#decisionversion" >}}">cadenzaflow:decisionVersion</a> is required.
    </td>
  </tr>
  <tr>
    <th>Default Value</th>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Constraints</th>
    <td colspan="2">
      If the value is set to <code>version</code> the attribute <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-attributes.md#processversion" >}}">cadenzaflow:processVersion</a> is required, see <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-attributes.md#processbinding" >}}">Process Binding</a> for more information.
    </td>
  </tr>
  <tr>
    <th>Default Value</th>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td>
      The attribute specifies the case variable in which the returned decision result is saved. It can be used in combination with <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-attributes.md#mapdecisionresult" >}}">cadenzaflow:mapDecisionResult</a> to define a decision result mapping.
    </td>
  </tr>
  <tr>
    <th>Type</th>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td>
      The variable name that is attached to element <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-elements.md#variableonpart" >}}">cadenzaflow:variableOnPart</a> for which the sentry listens. Sentry is evaluated when the variable event transition occurs.
    </td>
  </tr>
  <tr>
    <th>Type</th>
  ...
  <tr>
    <th>CadenzaFlow extension element</th>
    <td>
      <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-elements.md#variableonpart" >}}">cadenzaflow:variableOnPart</a>
    </td>
  </tr>
</table>