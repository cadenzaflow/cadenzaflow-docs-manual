...
```xml
<humanTask id="theTask" name="Important task" cadenzaflow:dueDate="${dateVariable}"/>
```
...
```xml
<humanTask id="theTask" name="Important task" cadenzaflow:followUpDate="${dateVariable}"/>
```
...
CMMN defines some native assignment concepts which can be used in CadenzaFlow.
...
<table class="table table-striped">
  <tr>
    <th>Attributes</th>
    <td>
      <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-attributes.md#assignee" >}}">cadenzaflow:assignee</a>,
      <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-attributes.md#candidategroups" >}}">cadenzaflow:candidateGroups</a>,
      <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-attributes.md#candidateusers" >}}">cadenzaflow:candidateUsers</a>,
      <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-attributes.md#duedate" >}}">cadenzaflow:dueDate</a>,
      <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-attributes.md#formkey" >}}">cadenzaflow:formKey</a>,
      <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-attributes.md#priority" >}}">cadenzaflow:priority</a>
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      <a href="{{< ref "/reference/cmmn11/custom-extensions/cadenzaflow-elements.md#tasklistener" >}}">cadenzaflow:taskListener</a>,
  ...
  <tr>
    <th>Constraints</th>
    <td>
      The attribute <code>cadenzaflow:assignee</code> cannot be used simultaneously with the <code>perfomerRef</code>
