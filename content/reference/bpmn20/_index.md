...
<a href="http://cadenzaflow.org/bpmn/tutorial.html">BPMN Tutorial</a> first.
{{< /note >}}
...
[Events: Basic Concepts](http://cadenzaflow.org/bpmn/reference.html#events-basic-concepts)
chapter of the [BPMN Modeling Reference](http://cadenzaflow.org/bpmn/reference.html).
{{< /note >}}
