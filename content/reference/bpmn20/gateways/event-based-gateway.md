...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      ...
      <code>cadenzaflow:asyncBefore</code> is set to <code>true</code>
    </td>
  </tr>
</table>
...
*   [Event-based Gateways](http://cadenzaflow.org/bpmn/reference.html#gateways-event-based-gateways) in the [BPMN 2.0 Modeling Reference](http://cadenzaflow.org/bpmn/reference.html)
