...
{{< note title="Limitation" class="warning" >}}
  Note that in CadenzaFlow's implementation of the parallel gateway, the gateway triggers as soon as the following holds: The number of arrived tokens is equal to the number of incoming sequence flows. It is not required that a token arrives on *every* incoming flow.
{{< /note >}}
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      ...
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#executionlistener" >}}">cadenzaflow:executionListener</a>
    </td>
  </tr>
  <tr>
    <th>Constraints</th>
...
*   [Parallel Gateways](http://cadenzaflow.org/bpmn/reference.html#gateways-parallel-gateways) in the [BPMN 2.0 Modeling Reference](http://cadenzaflow.org/bpmn/reference.html)
