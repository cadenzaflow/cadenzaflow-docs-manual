...
# CadenzaFlow-specific behavior 

Note that in CadenzaFlow's implementation of the inclusive gateway, the following holds: 
...
*   [Inclusive Gateways](http://cadenzaflow.org/bpmn/reference.html#gateways-data-based-inclusive-gateways) in the [BPMN 2.0 Modeling Reference](http://cadenzaflow.org/bpmn/reference.html)
