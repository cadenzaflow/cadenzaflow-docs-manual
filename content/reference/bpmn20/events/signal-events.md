...
```xml
<intermediateThrowEvent id="signal">
  <signalEventDefinition signalRef="newCustomerSignal" cadenzaflow:asyncBefore="true" />
</intermediateThrowEvent>
```
...
<signalEventDefinition signalRef="newCustomerSignal">
    <extensionElements>
        <cadenzaflow:in source="throwingVariableName" target="catchingVariableName" />
    </extensionElements>
</signalEventDefinition>
```

The variables declared in the "cadenzaflow:in" elements are set in the highest possible variable scope at the signal-catching process instance.
...
<signalEventDefinition signalRef="newCustomerSignal">
    <extensionElements>
        <cadenzaflow:in variables="all" local="true" />
        <cadenzaflow:in source="X" target="Y" />
        <cadenzaflow:in sourceExpression="${X + 5}" target="Z" />
    </extensionElements>
</signalEventDefinition>
```
...
The business key "cadenzaflow:in" element can be used in combination with the process variable passing "cadenzaflow:in" elements.
  ...
  <tr>
    ...
    <td>
      ...
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#failedjobretrytimecycle" >}}">
        cadenzaflow:failedJobRetryTimeCycle</a>,
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#inputoutput" >}}">
        cadenzaflow:inputOutput</a>
    </td>
  </tr>
...
*   [Signal Events](http://cadenzaflow.org/bpmn/reference.html#events-signal) in the [BPMN 2.0 Modeling Reference](http://cadenzaflow.org/bpmn/reference.html)
