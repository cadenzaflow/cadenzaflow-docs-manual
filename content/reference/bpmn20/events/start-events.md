...
<table class="table table-striped">
  <tr>
    ...
    <td>
      ...
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#initiator" >}}">cadenzaflow:initiator</a>,
  ...
  <tr>
    <td></td>
    <td>
      The attributes <code>cadenzaflow:asyncBefore</code> and <code>cadenzaflow:initiator</code> are only available for start events of a Process
    </td>
  </tr>
  <tr>
    <td></td>
  ...
  <tr>
    <td></td>
    <td>
      The attributes <code>cadenzaflow:formHandlerClass</code> and <code>cadenzaflow:formKey</code>
