...
<subprocess triggeredByEvent="true">
  <startEvent id="catchEscalation" isInterrupting="false">
    <escalationEventDefinition cadenzaflow:escalationCodeVariable="code"/>
  </startEvent>
  <!-- ... -->
</subprocess>
```
...
<table class="table table-striped">
  <tr>
    <th>Attributes</th>
    <td>
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#escalationcodevariable" >}}">cadenzaflow:escalationCodeVariable</a>
    </td>
  </tr>
  <tr>
