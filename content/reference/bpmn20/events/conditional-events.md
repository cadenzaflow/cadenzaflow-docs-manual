...
In CadenzaFlow, conditional events are triggered with the help of process variables.
...
For that, the CadenzaFlow extension attributes `cadenzaflow:variableName` and `cadenzaflow:variableEvents` can be used.
...
```xml
<conditionalEventDefinition cadenzaflow:variableName="var1"
                            cadenzaflow:variableEvents="create, update">
  <condition type="tFormalExpression">${var1 == 1}</condition>
</conditionalEventDefinition>
```
...
<startEvent id="conditionalStartEvent">
  <conditionalEventDefinition cadenzaflow:variableName="temperature">
...
<table class="table table-striped">
  <tr>
    <th>Attributes</th>
    <td>
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#variablename" >}}">cadenzaflow:variableName</a>,
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#variableevents" >}}">cadenzaflow:variableEvents</a>,
    </td>
  </tr>
  <tr>
...
* [Conditional Events](http://cadenzaflow.org/bpmn/reference.html#events-conditional) in the [BPMN 2.0 Modeling Reference](http://cadenzaflow.org/bpmn/reference.html)
