...
title: 'CadenzaFlow BPMN Extension Elements'
weight: 10
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      The configuration of a cadenzaflow connector.
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
  ...
  <tr>
    ...
    <td colspan="2">
      ...
      cadenzaflow:connectorId</a> child element is required and must identify a connector implementation
...
<table class="table table-striped">
  ...
  <tr>
    <th>Parent elements</th>
    <td colspan="2">
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#validation" >}}">cadenzaflow:validation</a>
    </td>
  </tr>
  <tr>
    <th>Child elements</th>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Parent elements</th>
    <td colspan="2">
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#map" >}}">cadenzaflow:map</a>
    </td>
  </tr>
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#list" >}}">cadenzaflow:list</a>,
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#map" >}}">cadenzaflow:map</a>,
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#script" >}}">cadenzaflow:script</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      see <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#class" >}}">cadenzaflow:class</a>
    </td>
  </tr>
  <tr>
    <td></td>
    <td><code>expression</code></td>
    <td>
      see <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#expression" >}}">cadenzaflow:expression</a>
    </td>
  </tr>
  <tr>
    <td></td>
    ...
    <td>
      see <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#delegateexpression" >}}">cadenzaflow:delegateExpression</a>
    </td>
  </tr>
  <tr>
    <th>Constraints</th>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#expression" >}}">cadenzaflow:expression</a>,
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#string" >}}">cadenzaflow:string</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#formfield" >}}">cadenzaflow:formField</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  ...
  <tr>
    <td></td>
    <td colspan="2">
      The child element <code>cadenzaflow:properties</code> is only allowed once
    </td>
  </tr>
  <tr>
    <td></td>
    <td colspan="2">
      The child element <code>cadenzaflow:validation</code> is only allowed once
    </td>
  </tr>
  <tr>
    <td></td>
    <td colspan="2">
      The child elements <code>cadenzaflow:values</code> can only be used if the <code>type</code> attribute is set to <code>enum</code>
    </td>
  </tr>
  <tr>
    <th>Parent elements</th>
    <td colspan="2">
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#formdata" >}}">cadenzaflow:formData</a>
    </td>
  </tr>
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#properties" >}}">cadenzaflow:properties</a>,
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#validation" >}}">cadenzaflow:validation</a>,
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#value" >}}">cadenzaflow:value</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td colspan="2">
      Metadata to define a form field (<strong>Deprecated</strong>, use <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#formdata" >}}">cadenzaflow:formData</a>).
    </td>
  </tr>
  <tr>
    <th>Attributes</th>
...
<table class="table table-striped">
  <tr>
    ...
    <td colspan="2">
      ...
      <code><br/>
        &lt;cadenzaflow:list&gt;<br/>
        &nbsp;&nbsp;&lt;cadenzaflow:value&gt;one&lt;/cadenzaflow:value&gt;<br/>
        &nbsp;&nbsp;&lt;cadenzaflow:value&gt;two&lt;/cadenzaflow:value&gt;<br/>
        &nbsp;&nbsp;&lt;cadenzaflow:value&gt;three&lt;/cadenzaflow:value&gt;<br/>
        &lt;/cadenzaflow:list&gt;
      </code><br/>
      A <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#script" >}}">
      cadenzaflow:script</a> element can also be used as a list element. The return value of the
  ...
  <tr>
    ...
    <td colspan="2">
      ...
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#outputparameter" >}}">
        cadenzaflow:outputParameter</a>,
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#list" >}}">cadenzaflow:list</a>,
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#entry" >}}">cadenzaflow:entry</a>
    </td>
  </tr>
  <tr>
    <th>Child elements</th>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#property" >}}">cadenzaflow:property</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Constraints</th>
    <td colspan="2">
      If the property belongs to a <code>cadenzaflow:formField</code> extension element, only
  ...
  <tr>
    <td></td>
    <td colspan="2">
      If the parent <code>cadenzaflow:properties</code> element is directly added as an extension element,
      for example by the cadenzaflow Modeler, only the attributes <code>name</code> and <code>value</code>
      are used.
    </td>
  </tr>
  <tr>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Child elements</th>
    <td colspan="2">
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#constraint" >}}">cadenzaflow:constraint</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td colspan="2">
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#formfield" >}}">cadenzaflow:formField</a>,
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#formproperty" >}}">cadenzaflow:formProperty</a>
    </td>
  </tr>
  <tr>
    <th>Child elements</th>
