...
title: 'CadenzaFlow BPMN Extension Attributes'
weight: 20
...
menu:
  main:
    ...
    pre: "Reference of CadenzaFlow Extension Attributes for BPMN."

---

The following attributes are extension attributes for the `cadenzaflow` namespace `http://cadenzaflow.org/schema/1.0/bpmn`.
...
<table class="table table-striped">
  ...
  <tr>
    <th>Type</th>
    <td><code>java.lang.String</code> or <code>org.cadenzaflow.bpm.engine.delegate.Expression</code></td>
  </tr>
  <tr>
...
<table class="table table-striped">
  <tr>
    ...
    <td>
      ...
      If the value is <code>version</code>, the attribute <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#calledelementversion" >}}">cadenzaflow:calledElementVersion</a> is required.
      If the value is <code>versionTag</code>, the attribute <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#calledelementversiontag" >}}">cadenzaflow:calledElementVersionTag</a> is required.
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td>
      The attribute specifies which process definition version of the subprocess the call activity calls if the <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#calledelementbinding" >}}">cadenzaflow:calledElementBinding</a>
  ...
  <tr>
    <th>Type</th>
    <td><code>java.lang.Integer</code> or <code>org.cadenzaflow.bpm.engine.delegate.Expression</code></td>
  </tr>
  <tr>
    <th>Possible Values</th>
    <td>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td>
      The attribute specifies which process definition version tag of the subprocess the call activity calls if the <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#calledelementbinding" >}}">cadenzaflow:calledElementBinding</a>
...
<table class="table table-striped">
  <tr>
    ...
    <td>
      ...
      If the value is <code>version</code>, the attribute <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#caseversion" >}}">cadenzaflow:caseVersion</a>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Possible Values</th>
    <td>
      Fully qualified Java class name of a class which implements a <a href="{{< ref "/user-guide/process-engine/delegation-code.md#java-delegate" >}}">Java Delegate</a> interface, e.g., <code>org.cadenzaflow.bpm.MyJavaDelegate</code>
    </td>
  </tr>
  <tr>
    <th>Default Value</th>
  ...
  <tr>
    ...
    <td>
      ...
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#tasklistener" >}}">cadenzaflow:taskListener</a>,
      <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-elements.md#executionlistener" >}}">cadenzaflow:executionListner</a>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  <tr>
    ...
    <td>
      ...
      If the value is <code>version</code>, the attribute <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#decisionrefversion" >}}">cadenzaflow:decisionRefVersion</a>
      is required.
      If the value is <code>versionTag</code>, the attribute <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#decisionrefversiontag" >}}">cadenzaflow:decisionRefVersionTag</a>
      is required.
    </td>
  </tr>
  <tr>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td>
      The attribute specifies which decision definition version the task evaluates if the <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#decisionrefbinding" >}}">cadenzaflow:decisionRefBinding</a>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td>
      The attribute specifies which decision definition version tag the task evaluates if the <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#decisionrefbinding" >}}">cadenzaflow:decisionRefBinding</a>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Type</th>
    <td><code>org.cadenzaflow.bpm.engine.delegate.Expression</code></td>
  </tr>
  <tr>
    <th>Possible Values</th>
    <td>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Possible Values</th>
    <td>
      Fully qualified Java class name of a class which implements the <code>org.cadenzaflow.bpm.engine.impl.form.handler.StartFormHandler</code>
      or <code>org.cadenzaflow.bpm.engine.impl.form.handler.TaskFormHandler</code> interface, e.g., <code>org.cadenzaflow.bpm.MyUserTaskFormHandler</code>
    </td>
  </tr>
  <tr>
    <th>Default Value</th>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td>
      The attribute references a CadenzaFlow form definition by its key. See <a href="{{< ref "/user-guide/task-forms/_index.md" >}}">task forms</a> for more information.
    </td>
  </tr>
  <tr>
    <th>Type</th>
  ...
  <tr>
    <th>Possible Values</th>
    <td>
      A <code>java.lang.String</code> or a <code>org.cadenzaflow.bpm.engine.delegate.Expression</code> which <a href="{{< ref "/webapps/tasklist/_index.md" >}}">Tasklist</a> can evaluate to display the referenced CadenzaFlow Form, e.g., myCadenzaFlowFormDefinitionKey or ${formKey}.
    </td>
  </tr>
  <tr>
    <th>Default Value</th>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
      <td>
      The attribute specifies which CadenzaFlow form definition version the activity references. If the value is <code>version</code>, the attribute <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#formrefversion" >}}">cadenzaflow:formRefVersion</a> is required.
    </td>
  </tr>
  <tr>
    <th>Type</th>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td>
      The attribute specifies which CadenzaFlow form definition version the activity references if the <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#formrefbinding" >}}">cadenzaflow:formRefBinding</a>
      is set to <code>version</code>.
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <th>Possible Values</th>
    <td>
      A concrete version of all deployed version numbers of the CadenzaFlow form definition as <code>java.lang.Integer</code> or an expression which evaluates to a <code>java.lang.Integer</code> e.g., <code>${versionToReference}</code>
    </td>
  </tr>
  <tr>
    <th>Default Value</th>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Type</th>
    <td>A number in the range of a Java <code>long</code> value or <code>org.cadenzaflow.bpm.engine.delegate.Expression</code></td>
  </tr>
  <tr>
    <th>Possible Values</th>
    <td>
...
<table class="table table-striped">
  <tr>
    ...
    <td>
      <p>
      The attribute specifies the process variable to save the return value of a <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#expression" >}}">cadenzaflow:expression</a>.
      </p>
      <p>
...
<table class="table table-striped">
  <tr>
    <th>Description</th>
    <td>
      The attribute specifies the topic of an external task instance. The task is going to be offered to workers polling for that topic. It is only relevant when <a href="{{< ref "/reference/bpmn20/custom-extensions/extension-attributes.md#type" >}}">cadenzaflow:type</a> is set to <code>external</code>.
    </td>
  </tr>
  <tr>
    <th>Type</th>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Possible Values</th>
    <td>
      Fully qualified Java class name of a class which implements the <a href="{{< ref "/user-guide/process-engine/delegation-code.md#delegate-variable-mapping" >}}">Delegate Variable Mapping</a> interface, e.g., <code>org.cadenzaflow.bpm.MyVariableMappingDelegate</code>
    </td>
  </tr>
  <tr>
    <th>Default Value</th>
