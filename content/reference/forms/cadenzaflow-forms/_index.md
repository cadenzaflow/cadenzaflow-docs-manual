...
title: 'Cadenzaflow Forms Reference'
weight: 60
layout: "single"

menu:
  main:
    name: "Cadenzaflow Forms"
    identifier: "cadenzaflow-forms-ref"
    parent: "forms-ref"
    pre: "Forms created with the Cadenzaflow Modeler embeddable in Tasklist"
---

Cadenzaflow Forms allow you to easily design and configure forms and then embed them in the Cadenzaflow Tasklist.

* Cadenzaflow Forms are created in the Cadenzaflow Modeler. You can find out how in the [Cadenzaflow Modeler documentation]({{< ref "/modeler/forms.md" >}}).
* Cadenzaflow Forms can easily be embedded in the Cadenzaflow Tasklist. You can find out how in the [User Task Forms guide]({{< ref "/user-guide/task-forms/_index.md#camunda-forms" >}}).
* Cadenzaflow Forms are powered by the open source [bpmn-io form-js library](https://github.com/bpmn-io/form-js). Visit the [open source repository](https://github.com/bpmn-io/form-js) to find out how to render a form using plain JavaScript in a custom application (note that this also requires you to to fetch the form from the respective BPMN 2.0 element and provide data as needed to the form).


# Components

Use the [Cadenzaflow Modeler]({{< ref "/modeler/forms.md" >}}) to configure your Cadenzaflow Form. The following form elements are currently supported.
...
* **Text**: Either **Markdown** or **basic HTML** which will be rendered in the Form. Please note that dangerous HTML elements will not be rendered so to prevent the risk of cross-site scripting using Cadenzaflow Forms.
...
Each Cadenzaflow Forms component which allows data manipulation has a **Key** attribute. This attribute is used as an identifier to map data of the respective field (1) during initial loading of the form, and (2) during submission of the form.

When a form is [referenced by a User Task or Start Event]({{< ref "/user-guide/task-forms/_index.md#cadenzaflow-forms" >}}) and viewed in the [Cadenzaflow Tasklist]({{< ref "/webapps/tasklist/_index.md" >}}), the key will be used to refer to a [Process Variable]({{< ref "/user-guide/process-engine/variables.md" >}}). This means that the value of the Process Variable will be used to populate the respective component initially and that the value of the component will be saved in the Process Variable during submission of the form.
