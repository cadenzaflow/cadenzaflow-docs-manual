...
This reference covers the features of the CadenzaFlow Forms SDK. The Forms SDK simplifies the
...
{{< note title="The Forms SDK and CadenzaFlow Tasklist" class="info" >}}
<a href="{{< ref "/webapps/tasklist/_index.md" >}}">
CadenzaFlow Tasklist</a> uses the Form SDK for providing support for Embedded Forms. By default, the 
