  ...
  camForm.on('form-loaded', function() {
    ...
    camForm.variableManager.createVariable({
      ...
      valueInfo: {
        ...
        objectTypeName: 'org.cadenzaflow.bpm.example.CustomerData'
      }
    });
...
A full example of this feature can be found in the [CadenzaFlow Examples Repository](https://github.com/cadenzaflow/cadenzaflow-bpm-examples/tree/master/usertask/task-form-embedded-serialized-java-object).
