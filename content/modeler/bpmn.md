...
title: 'Modeling BPMN in CadenzaFlow Modeler'
weight: 10

menu:
  main:
    name: "BPMN"
    identifier: "cadenzaflow-modeler-bpmn"
...
To start modeling, create a new BPMN 2.0 diagram for the CadenzaFlow Platform by selecting **Create diagram > Create new BPMN diagram (CadenzaFlow Platform)** in the top-level menu.
...
The CadenzaFlow Modeler covers all BPMN 2.0 elements for modeling processes and collaborations.
