...
title: 'Editing DMN in CadenzaFlow Modeler'
weight: 20

menu:
  main:
    name: "DMN"
    identifier: "cadenzaflow-modeler-dmn"
...
To start modeling, create a new DMN 1.3 diagram for the CadenzaFlow Platform by selecting **Create diagram > Create new DMN diagram (CadenzaFlow Platform)** in the top-level menu.
...
The CadenzaFlow Modeler covers the following elements:
